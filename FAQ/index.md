...
11. [На Caddx Vista не работает кастом OSD](#На Caddx Vista не работает кастом OSD)
...
> * **Важно**: включите *сначала* очки, *потом* передатчик.
>* Косвенно можно определить успешность хака по кол-ву каналов в 25Мбит - каналов должно быть 8.
> 
